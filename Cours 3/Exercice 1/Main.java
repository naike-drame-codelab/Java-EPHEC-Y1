...
public class Main {
    public static void main(String[] args) {
        ...
        // Demander un nb à l'utilisateur
        System.out.println("Veuillez entrer un nombre (x) : ");
        double x = readNextDouble();
        double result;
       
        // calculer
        result = equationSolver(x); 
        
        // afficher résultat
        System.out.println("Le résultat de l'équation est : " + result);
    }

    private static double equationSolver(double x){
        return 3 * (2 - x) / 2 * 3 + -1 * x * x * x + 42; // pas besoin de parenthèses superflues
    }
