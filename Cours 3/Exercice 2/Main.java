...
public class Main {
    public static void main(String[] args) {
        ...
        double resultatInitial = ((1 + 2) - 3) * (4/5);
        double resultatSansParentheses = (1 + 2 - 3) * (4/5);
        
        System.out.println("Résultat initial = " + resultatInitial);
        System.out.println("Résultat sans les parenthèses inutiles = " + resultatSansParentheses);
